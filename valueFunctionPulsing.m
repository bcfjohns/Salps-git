function cost = valueFunctionPulsing()

global Salp1_PandV Salp1_angles backConnect uPeriod
...
%calculate average velocity, cause the pulsing prevents fitting a spiral to
%it.
...
cost = cost/uPeriod; %to account for the fact that a shorter period has more pulses.
end
